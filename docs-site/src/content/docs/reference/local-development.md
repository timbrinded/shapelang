...
Use the Bun workspace when contributing to Shape itself. Application repos should usually install the released `shp` binary (currently `0.9.0` / `v0.9.0`) instead.
