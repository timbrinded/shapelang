...
| `shp graph [SYMBOL] [--kind KIND] [files...]` | Inspecting hyperedges. With a SYMBOL: incidence for that vertex or relation. Without a SYMBOL: the whole hypergraph, grouped by kind. | Effect or Memory Guard checks. |
