...
Release candidates now run a blocking behavioral evaluation across all five
skills and pause at a protected manual approval environment before an official
release tag is allowed.
